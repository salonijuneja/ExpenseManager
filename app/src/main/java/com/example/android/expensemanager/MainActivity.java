...
String state;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        state=getSharedPreferences("state",MODE_PRIVATE).getString("selected","");
        if(state.equals("day"))
        {
        ...
        else if(state.equals("year"))
        {
            ...
            Cursor c=ob.getRequiredData("month", month+1);
            if(c.getCount()==0) {
    ...
    public void onClick(View v) {
      //  Toast.makeText(this,"No button clicked"+v.getId(),Toast.LENGTH_SHORT).show();
        switch(v.getId()) {
            case R.id.button1:
